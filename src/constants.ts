export const contacts: Record<string, string> = Object.freeze({
  telegram: 'https://t.me/romanovalpm',
  email: 'smnfox61@gmail.com',
  github: 'https://github.com/smnfox',
  resume: '/resume.pdf',
});
export const rickrollLink = 'https://youtu.be/dQw4w9WgXcQ';
export const myCompanies = [
  ...
  },
  {
    ...
    responsibilities: [
      'Написание нового интерфейса админ панели на vue2 с использованием библиотеки компонентов ant design',
      'Поддержка и рефакторинг старых разделов сервиса на php, с использованием jquery и vue 2',
